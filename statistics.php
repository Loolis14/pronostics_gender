        ...
        <div class="case">
            ...
            <div class="astro-case">
                ...
                <section class="astro-pourcentage">
                    <p><?=$scorpion/$nb_participants * 100?>%</p>
                    <p><?=$sagittaire/$nb_participants * 100?>%</p>
                </section>
        </div>
        <div class="case">
